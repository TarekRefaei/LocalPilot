...
export const COMMAND_IDS = {
  ...
  planStepAdd: 'localpilot.plan.step.add',
  planStepToggle: 'localpilot.plan.step.toggle',
  planStepMoveUp: 'localpilot.plan.step.moveUp',
  planStepMoveDown: 'localpilot.plan.step.moveDown',
  planStepDelete: 'localpilot.plan.step.delete',
