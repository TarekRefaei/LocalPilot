...
- Script files MUST NOT contain:
 ...
 - If you need to produce an output in a script file:
  - You MUST use print(...)
  - You MUST NOT assign the result to a variable that is returned
  - You MUST NOT use return under any circumstances
